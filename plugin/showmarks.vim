...
let s:reduced_marks = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"
...
if !hasmapto( '<Plug>ShowmarksShowMarksToggle' ) | noremap <silent> Mt :ShowMarksToggle<cr>|    endif
if !hasmapto( '<Plug>ShowmarksShowMarksOn'     ) | noremap <silent> Mo :ShowMarksOn<cr>|        endif
if !hasmapto( '<Plug>ShowmarksClearMark'       ) | noremap <silent> Mh :ShowMarksClearMark<cr>| endif
if !hasmapto( '<Plug>ShowmarksClearAll'        ) | noremap <silent> Ma :ShowMarksClearAll<cr>|  endif
if !hasmapto( '<Plug>ShowmarksPlaceMark'       ) | noremap <silent> Mm :ShowMarksPlaceMark<cr>| endif
...
fun! s:IncludeMarks()
	...
	if !exists('g:showmarks_include')
		let g:showmarks_include = s:reduced_marks
	endif
